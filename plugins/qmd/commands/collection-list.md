...
Shows all collections with metadata: name, path, glob pattern, file count, and last updated timestamp. Collections with `includeByDefault: false` display an `[excluded]` tag.
